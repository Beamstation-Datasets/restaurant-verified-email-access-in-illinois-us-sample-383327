# Restaurant Verified Email Access in Illinois, US

> Free BeamStation sample export with 542 rows and masked direct-contact fields.
...
| Full dataset size | 5,425 records |
| Free sample size | 542 records (9.99%) |
| Last export | 2026-04-29T15:29:36.098635+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/restaurant-verified-email-access-in-illinois-us-sample-383327/releases/download/sample-latest/beamstation_383327_restaurants-us-il_SAMPLE_DIST.csv) |
...
Search for dataset ID `383327` on BeamStation if you want the exact commercial listing.
